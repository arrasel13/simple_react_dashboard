...
const WorkReport = () => {
  ...
  return (
    <>
      <BreadCrumb bTitle="Support Report" bText="Support Report" />
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div class="relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  class="dark:bg-dark-900 h-[42px] w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-[42px] pr-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[300px]"
                  value={globalFilter}
                  onChange={(e) => {
                  ...
                  {paginatedData.map((row, idx) => (
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className=" px-4 sm:px-6 py-3.5">
                        <div class="flex h-10 w-10 w-10 h-10 items-center justify-center rounded-full bg-error-100 text-error-600">
                      ...
                      <td className=" px-4 sm:px-6 py-3.5">
                        <div class="flex items-center w-full gap-2">
                          <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500 cursor-pointer">
                            <svg
                              width="1em"
                              height="1em"
                              viewBox="0 0 20 20"
                          ...
                          <button class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90 cursor-pointer">
                            <svg
                              width="1em"
                              height="1em"
                              viewBox="0 0 21 21"
